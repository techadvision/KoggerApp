...
// The Pulse user interface, lifted out of Plot2D.qml unchanged.
//
...
// other things it reached for stay behind in Plot2D and are passed in:
//   plot   - the WaterFall root (plot.quickChangeMaxRangeValue, plot.updatePlot(), ...)
//   pinch  - the PinchArea, for its isLiveView flag
//
// Nothing else crosses the boundary. Plot2D calls exactly three things on this
// component, declared under "API used by Plot2D" below.
